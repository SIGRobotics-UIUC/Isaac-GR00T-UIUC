<<<<<<< Updated upstream
NVIDIA GR00T N-1.5 adapted for bimanual SO101 arms + data conversion from HF 3.0 to 2.1 to support all types of data collection
=======
<div align="center">
...
**NEW**: Automatically upload your fine-tuned models to Hugging Face Hub!
...
# Train with auto-upload (same command as before!)
python scripts/gr00t_finetune.py --dataset-path ./demo_data/robot_sim.PickNPlace --num-gpus 1
```

Your model will be automatically uploaded with a complete model card, training metadata, and usage examples. See [`HUGGINGFACE_UPLOAD.md`](HUGGINGFACE_UPLOAD.md) for full documentation.

_Hardware Performance Considerations_
...
_What is the inference speed for Gr00tPolicy?_
...
_How to train with multiple datasets?_
...
_Is LoRA finetuning supported?_
...
_How to use GR00T on Blackwell Architecture?_
